...
class S {
  ...
  String get amountShouldNotBeGreaterThan {
    return Intl.message(
      'Amount should not be greater than',
      name: 'amountShouldNotBeGreaterThan',
      desc: '',
      args: [],
    );
  }
  ...
  String get ifNotChosenYoullNeedToManuallyEnterYourCardDetailsInTheNextStep {
    return Intl.message(
      'If not chosen, you\'ll need to manually enter your card details in the next step',
      name: 'ifNotChosenYoullNeedToManuallyEnterYourCardDetailsInTheNextStep',
      desc: '',
      args: [],
    );
  }
  ...
  String get pleaseSelectAPlanWhichIsUnpaid {
    return Intl.message(
      'Please select a plan which is unpaid or partially paid',
      name: 'pleaseSelectAPlanWhichIsUnpaid',
      desc: '',
      args: [],
    );
  }
  ...
  String get scanTheQRCodeToViewInvoiceDetails {
    return Intl.message(
      'Scan the QR code to view invoice details',
      name: 'scanTheQRCodeToViewInvoiceDetails',
      desc: '',
      args: [],
    );
  }
  ...
  String get scanTheQRCodeToViewSubscriptionDetails {
    return Intl.message(
      'Scan the QR code to view subscription details',
      name: 'scanTheQRCodeToViewSubscriptionDetails',
      desc: '',
      args: [],
    );
  }

  /// `Scan to pay with BCTPay app`
  String get scanToPayWithBCTPayApp {
    return Intl.message(
      'Scan to pay with BCTPay app',
      name: 'scanToPayWithBCTPayApp',
      desc: '',
      args: [],
    );
  }
  ...
  /// `You can't add more than {code} docs`
  String youCantAddMoreThanDocs(Object code) {
    return Intl.message(
      'You can\'t add more than $code docs',
      name: 'youCantAddMoreThanDocs',
      desc: '',
      args: [code],
    );
  }
  ...
  String yourPaymentHasBeenSuccessfullyDone(Object code) {
    return Intl.message(
      'Your payment of $code has been sent successfully.',
