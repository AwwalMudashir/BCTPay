...
Future<PaymentRequestsByMeResponse> paymentRequestByMeList({
  required int page,
  required int limit,
}) async {
  final url =
      "$baseUrlCustomerTxn/${ApiEndpoint.paymentRequestListForReceiiver}";
  ...
  if (response.statusCode == 200) {
    ...
    return PaymentRequestsByMeResponse.fromJson(data);
  } else {
