...
Future<BankLookupResponse> getBankList({required String countryCode}) async {
  final uri = Uri.parse("$baseUrlCore/lookupdata/banks")
  ...
  if (response.statusCode == 200) {
    return BankLookupResponse.fromJson(json.decode(response.body));
  } else {
