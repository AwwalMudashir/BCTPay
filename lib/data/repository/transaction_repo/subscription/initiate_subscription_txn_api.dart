...
Future<InitiateTransactionResponse> initiateSubscriptionTxn({
  ...
  if (subscription != null) {
    ...
    body["plan_list"] =
        subscription.planInfo?.map((plan) => plan.toJson()).toList();
  }
  // debugPrint(jsonEncode(body));
  //log("🚀initiate_subscription_payment ~ ${jsonEncode(body)}:");
  var response = await http.post(
    Uri.parse("$baseUrlCustomerTxn/${ApiEndpoint.initiateSubscriptionTxn}"),
