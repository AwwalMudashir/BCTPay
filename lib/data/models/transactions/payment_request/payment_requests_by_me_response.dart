...
class PaymentRequestsByMeResponse {
  final int code;
  final PaymentRequestsByMeData? data;
  final String message;
  final bool? success;

  PaymentRequestsByMeResponse({
    required this.code,
    required this.data,
  ...
  factory PaymentRequestsByMeResponse.fromJson(Map<String, dynamic> json) =>
      PaymentRequestsByMeResponse(
        code: json["code"],
        data: json["data"] == null
            ? null
            : PaymentRequestsByMeData.fromJson(json["data"]),
...
class PaymentRequestsByMeData {
  final List<PaymentRequest> list;
  final int count;

  PaymentRequestsByMeData({
    required this.list,
    required this.count,
  });

  factory PaymentRequestsByMeData.fromJson(Map<String, dynamic> json) =>
      PaymentRequestsByMeData(
