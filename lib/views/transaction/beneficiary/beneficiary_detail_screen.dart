...
class BeneficiaryDetail extends StatefulWidget {
  ...
  const BeneficiaryDetail({super.key, this.account});
...
class _BeneficiaryDetailState extends State<BeneficiaryDetail> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      var args =
          ModalRoute.of(context)?.settings.arguments as BeneficiaryDetail;
  ...
  Widget build(BuildContext context) {
    var args = ModalRoute.of(context)?.settings.arguments as BeneficiaryDetail;
    var account = args.account;
    var textTheme = Theme.of(context).textTheme;
    return Scaffold(
      appBar: CustomAppBar(title: appLocalizations(context).beneficiaryDetail),
      body: BlocConsumer(
            ...
            return ModalProgressHUD(
              ...
              child: ListView(
                children: [
                  ...
                  _listItem(
                      appLocalizations(context).accountAddedOnBeneficiaryDetail,
